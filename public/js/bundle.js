...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/faridullah123/ckzkrlzun00ej14l9v1ueo5jc' // center: [73.0479, 33.6844],
    // zoom: 8
...
// DOM Elements
var loginFormElem = document.querySelector('.form');
var mapElem = document.getElementById('map'); // Delegation

if (mapElem) {
  var locations = JSON.parse(mapElem.dataset.locations);
